...
var creatorList = ['@Abdurganz','@bob asu','@alpha'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey !='Bob asu') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Bob asu') return res.json(loghandler.invalidKey)
